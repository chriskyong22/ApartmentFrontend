...
export const Header = () => {
    ...
    const toggleModal = () => {
        setShowLoginModal(oldValue => !oldValue);
    }

    return (
        <header className="header black-background-color ">
            <div aria-label="Logo" className="white-color">
                <h2>
                    Logo
                </h2>
            </div>
            <div className="loginForm" aria-label="LoginForm">
                <div>
                    <svg onClick={toggleModal} version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000">
